                ...
                <form @submit="onMobileFormSubmit">
                    ...
                    <div class="form-item">
                        <div class="input">
                            ...
                            <span class="code" :class="{ disabled: isActive }" @click="getMsgCode">{{ isActive ?
                                    `剩余${count}秒` : "发送验证码"
                            }}</span>
                        </div>
...
// QQ 登录
const loginUrl = import.meta.env.VITE_APP_QQ_LOGIN

// 是否为短信登录
const isMsgLogin = ref(false);

const { onAccountFormSubmit, ...accountFormValid } = useAccountFormValidate()
const {
    accountField,
    passwordField,
    accountIsAgreeField,
